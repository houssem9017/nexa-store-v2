...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer className="siteFooter"><div className="footerMain"><div className="footerIntro"><a className="wordmark" href="#top">nexa<span>•</span></a><p>Des objets bien choisis pour votre quotidien.</p></div><div className="footerLinks"><div><strong>Boutique</strong><a href="#produits">Nouveautés</a><a href="#produits">Best-sellers</a><a href="#produits">Offres du moment</a></div><div><strong>Aide</strong><a href="#top">Livraison</a><a href="#top">Retours</a><a href="#top">FAQ</a></div><div><strong>Suivre Nexa</strong><a href="#top">Instagram</a><a href="#top">Facebook</a><a href="#top">TikTok</a></div></div></div><div className="footerBottom"><small>© 2026 Nexa Store · Tunisie</small><a href="https://visiotec.tn" target="_blank" rel="noreferrer">Built with Visiotec <span>↗</span></a></div></footer>

      <nav className="mobileNav" aria-label="Navigation mobile"><button className="active" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}><House className="mobileNavIcon" strokeWidth={1.8}/><span>Accueil</span></button><button onClick={() => browse()}><Grid2X2 className="mobileNavIcon" strokeWidth={1.8}/><span>Boutique</span></button><button onClick={() => setSearchOpen(true)}><Search className="mobileNavIcon" strokeWidth={1.8}/><span>Recherche</span></button><a href="/favoris" aria-label="Voir les favoris"><Heart className="mobileNavIcon" strokeWidth={1.8}/><span>Favoris</span></a><a href="/panier" aria-label="Voir le panier"><ShoppingBag className="mobileNavIcon" strokeWidth={1.8}/>{cart.length > 0 && <b>{cart.length}</b>}<span>Panier</span></a></nav>
