...
import { Cable, Gamepad2, Grid2X2, Headphones, Heart, House, Search, ShoppingBag, Smartphone, Watch } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer className="siteFooter"><div className="footerMain"><div className="footerIntro"><a className="wordmark" href="#top">nexa<span>•</span></a><p>Des objets bien choisis pour votre quotidien.</p></div><div className="footerLinks"><div><strong>Boutique</strong><a href="#produits">Nouveautés</a><a href="#produits">Best-sellers</a><a href="#produits">Offres du moment</a></div><div><strong>Aide</strong><a href="#top">Livraison</a><a href="#top">Retours</a><a href="#top">FAQ</a></div><div><strong>Suivre Nexa</strong><a href="#top">Instagram</a><a href="#top">Facebook</a><a href="#top">TikTok</a></div></div></div><div className="footerBottom"><small>© 2026 Nexa Store · Tunisie</small><a href="https://visiotec.tn" target="_blank" rel="noreferrer">Built with Visiotec</a></div></footer>
